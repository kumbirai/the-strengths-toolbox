...
/**
 * Migrate testimonials from both live websites
...
class TestimonialMigrationSeeder extends Seeder
{
    ...
    {
        $this->command->info('Importing testimonials from both live websites...');
     ...
     * - TSA Business School website homepage (tsabusinessschool.co.za)
     *
     * To add new testimonials, add entries to the $testimonials array below.
     */
