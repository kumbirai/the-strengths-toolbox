                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea id="meta_description" 
                                  ...
                                  rows="3"
                                  maxlength="160"
                                  class="w-full px-4 py-2 border border-neutral-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent @error('meta_description') border-red-500 @enderror">{{ old('meta_description') }}</textarea>
                        <p class="mt-1 text-sm text-neutral-500">
