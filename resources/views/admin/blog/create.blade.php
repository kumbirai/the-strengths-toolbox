...
<div class="bg-white rounded-lg shadow">
    ...
    <form method="POST" action="{{ route('admin.blog.store') }}" enctype="multipart/form-data" class="p-6">
        @csrf
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea id="excerpt" 
                                      name="excerpt" 
                                      rows="3"
                                      class="w-full px-4 py-2 border border-neutral-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent @error('excerpt') border-red-500 @enderror">{{ old('excerpt') }}</textarea>
                ...
                <div>
                    ...
                    <div>
                        ...
                        <textarea id="content" 
                                  ...
                                  rows="15"
                                  required
                                  class="w-full px-4 py-2 border border-neutral-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent @error('content') border-red-500 @enderror">{{ old('content') }}</textarea>
                        @error('content')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-neutral-50 rounded-lg p-4">
                    ...
                    <div class="space-y-2 max-h-48 overflow-y-auto">
                        ...
                        @empty
                            <p class="text-sm text-neutral-500">No categories available. <a href="{{ route('admin.blog.categories.create') }}" class="text-primary-600 hover:underline">Create one</a></p>
                        @endforelse
                    </div>
                </div>
                ...
                <div class="bg-neutral-50 rounded-lg p-4">
                    ...
                    <div class="space-y-2 max-h-48 overflow-y-auto">
                        ...
                        @empty
                            <p class="text-sm text-neutral-500">No tags available. <a href="{{ route('admin.blog.tags.create') }}" class="text-primary-600 hover:underline">Create one</a></p>
                        @endforelse
                    </div>
                </div>
            </div>
