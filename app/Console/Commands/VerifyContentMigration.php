...
class VerifyContentMigration extends Command
{
    ...
    protected array $requiredPages = [
        ...
        'sales-courses',
        'sales-courses/sales-fundamentals-and-advanced-techniques',
        'sales-courses/mastering-relationship-selling',
        'sales-courses/mindset-of-a-super-salesperson',
        'sales-courses/selling-on-the-phone',
