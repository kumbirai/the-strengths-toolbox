<?php
// Same as run-migrate.php but with a WAF-safe filename (many hosts block "run" or "migrate" in URLs).
// Use: upload to public/, add RUN_DEPLOY=1 to .env, visit /do-migrations.php once, then delete this file and the log.
